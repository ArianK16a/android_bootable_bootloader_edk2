...
ifneq ($(TARGET_BOOTLOADER_BOARD_MODEL),)
	...
	BOARD_BOOTLOADER_PRODUCT_MODEL := TP1803
endif

ifneq ($(TARGET_BOOTLOADER_BOARD_VERSION),)
	BOARD_BOOTLOADER_PRODUCT_VERSION := $(TARGET_BOOTLOADER_BOARD_VERSION)
else
	BOARD_BOOTLOADER_PRODUCT_VERSION := $(BUILD_ID)
endif
...
$(TARGET_ABL): $(LOCAL_ABL_SRC_FILE) | $(ABL_OUT) $(INSTALLED_KEYSTOREIMAGE_TARGET)
	$(MAKEPATH)make -C bootable/bootloader/edk2 \
		...
		BOARD_BOOTLOADER_PRODUCT_VERSION=$(BOARD_BOOTLOADER_PRODUCT_VERSION) \
